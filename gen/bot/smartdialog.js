    ...
    */
    ...
    dialog.matches('ShowMe', [
        function (session, args, next) {
            ...
            const result = Analyze.analyzeAll(a1.entity, theModel.rules, theModel.tools, gwords);
    ...
    dialog.matches('WhatIs', [
        function (session, args, next) {
            ...
            if (cats.length === 1) {
                ...
                const result = WhatIs.resolveCategory(cat, a1.entity, theModel.rules, theModel.records);
                ...
                const resultArr = WhatIs.resolveCategories(cats, a1.entity, theModel, domainCategoryFilter);
